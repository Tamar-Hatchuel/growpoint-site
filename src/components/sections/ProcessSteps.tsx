        ...
        {steps.map((step, index) => <div key={index} className="text-center relative">
          ...
          animationDelay: `${index * 0.2}s`
              ...
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-[#B5828C] font-semibold text-3xl">
            ...
            {index < steps.length - 1 && <div className="hidden md:block absolute top-1/2 -right-4 transform translate-x-1/2 -translate-y-1/2 z-10">
